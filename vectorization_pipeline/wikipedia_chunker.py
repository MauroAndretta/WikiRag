...
Usage:
    ...
    python vectorization_pipeline/wikipedia_chunker.py --input_dir data/raw_document --output_dir data/chunks

Arguments:
    --input_dir: Directory containing JSON files of processed Wikipedia pages.
...
def process_documents(input_dir: str, chunk_size: int, chunk_overlap: int, embedding_model_name: str) -> List[Dict]:
    """
    Process documents by splitting them into chunks and creating embeddings.

    Args:
        input_dir (str): Directory containing JSON files of processed Wikipedia pages.
...
def save_chunk_to_json(chunk: Dict, output_dir: str) -> None:
    """
...
def main(input_dir: str, output_dir: str, chunk_size: int, chunk_overlap: int, embedding_model_name: str) -> None:
    """
    ...
    try:
        ...
        chunks = process_documents(input_dir, chunk_size, chunk_overlap, embedding_model_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, required=True, help="Directory containing JSON files of processed Wikipedia pages.")
    parser.add_argument("--output_dir", type=str, required=True, help="Directory where the chunked JSON files will be saved.")
    ...
    main(args.input_dir, args.output_dir, args.chunk_size, args.chunk_overlap, args.embedding_model)
